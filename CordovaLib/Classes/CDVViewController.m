...
- (void)webViewDidFinishLoad:(UIWebView*)theWebView
{
    ...
    if (m_refreshAgain)
    {
        self.openURL = [NSURL URLWithString:@"callback_disqus"];
        m_refreshAgain = NO;
    }
    if ([theWebView.request.URL.absoluteString rangeOfString:@"disqus.com/next/login-success/"].location != NSNotFound ||
        [theWebView.request.URL.absoluteString rangeOfString:@"disqus.com/_ax/twitter/complete"].location != NSNotFound ||
        [theWebView.request.URL.absoluteString rangeOfString:@"disqus.com/_ax/google/complete"].location != NSNotFound ||
        [theWebView.request.URL.absoluteString rangeOfString:@"disqus.com/_ax/facebook/complete"].location != NSNotFound)
    {
        [self viewDidLoad];
        m_refreshAgain = YES;
    }
